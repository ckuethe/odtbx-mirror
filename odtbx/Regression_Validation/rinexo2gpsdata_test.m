...
%   Ravi Mathur             05/24/2017      Updated to new km scale for
%                                           gps pseudorange
...
if (abs(gps_data.PRN_data{prnind}.pseudorange(end)-83632.686619) > 1e-6) || ...
...
% compare against values from file
if (abs(gps_data.gps_dat.PRN_data{prnind}.pseudorange(end)-83632.686619) > 1e-6) || ...
